...
class BaseViewController: UIViewController {
    ...
    func setTexture(){
        texture.image = UIImage(named: "texture")
        ...
        texture.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 87).isActive = true
        texture.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -87).isActive = true
    }
    ...
    func setbuttons(){
        ...
        backButton.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -58).isActive = true
